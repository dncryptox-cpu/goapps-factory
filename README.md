...
| 3. Backend Core Library | **Đang chờ** — SP-001 đã build xong với code thật, các hàm `// SHARED` trong `Code.gs` sẵn sàng để tách |
| 4. Frontend UI Kit | **Đang chờ** — các phần `// SHARED` trong `index.html` (style nền, bootstrap, điều hướng tab) sẵn sàng để tách |
